...
description: '在 GoFrame 框架中使用数组类型，包括创建并发安全的数组、排序数组、数组遍历与修改以及数组的随机获取和出栈操作。通过示例代码演示了基本的数组操作，提供了数组的排序、过滤及翻转等高级用法。v2.10版本新增泛型数组TArray和SortedTArray，提供类型安全的数组操作，帮助开发者更好地理解和掌握 GoFrame 框架中的数组处理能力。'
---
